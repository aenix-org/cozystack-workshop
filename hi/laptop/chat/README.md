...
एक फ़ाइल, एक संदेश। इन्हें व्यावहारिक काम के साथ-साथ भेजें, सब एक साथ नहीं: वरना
प्रतिभागी आगे भाग जाएँगे और वहीं अटक जाएँगे जहाँ आपने अभी तक यह नहीं बताया कि इसकी ज़रूरत क्यों है।

जहाँ भी `workshopXX` दिखे, प्रतिभागी अपना ख़ुद का नंबर भरता है: `workshop03`,
`workshop07`, और इसी तरह। नंबर हर व्यक्ति को पासवर्ड के साथ अलग-अलग दिया जाता है।

हर फ़ाइल Telegram की सीमा — 4096 वर्ण — के भीतर आ जाती है।
...
| 4 | kubectl इंस्टॉल करना | [`04-install-kubectl.md`](04-install-kubectl.md) |
| 5 | virtctl इंस्टॉल करना | [`05-install-virtctl.md`](05-install-virtctl.md) |
| 6 | kubelogin इंस्टॉल करना | [`06-install-kubelogin.md`](06-install-kubelogin.md) |
| 7 | krew के बारे में — और हम इसका इस्तेमाल क्यों नहीं करते | [`07-about-krew.md`](07-about-krew.md) |
| 8 | क्लस्टर में लॉग इन करना | [`08-connect-to-cluster.md`](08-connect-to-cluster.md) |
| 9 | git इंस्टॉल करना | [`09-install-git.md`](09-install-git.md) |
| 10 | सामग्री लेना और अपना नंबर भरना | [`10-clone-and-set-number.md`](10-clone-and-set-number.md) |
