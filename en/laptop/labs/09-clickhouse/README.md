...
The tenant kubeconfig is fetched from the dashboard: **Info → the Secrets tab →
...
**inside the Pod**, from the Pod's variable. Your laptop doesn't see these values and doesn't
...
server. The data didn't travel over the network, didn't pass through your laptop, and didn't sit
