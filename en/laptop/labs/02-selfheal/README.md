...
# Until the variable is set, kubectl looks for a cluster on the laptop itself and doesn't find one.
...
Why from inside the cluster and not from the laptop: `port-forward` latches onto a specific Pod and
