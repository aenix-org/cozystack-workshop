## 28. Step 8: why the application still crashes

**The database is empty — the application needs its schema**

📍 **Where:** inside your own VM. It is already on the cluster network and can see the database by name.
...
<details>
<summary><b>Why health is green but the order won't create</b></summary>
...
<details>
<summary><b>What this file actually creates — a line-by-line breakdown</b></summary>
