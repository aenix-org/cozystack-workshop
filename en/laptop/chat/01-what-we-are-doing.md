...
**The addresses are hard-coded.** Not names — numbers. Someone once stood up three machines,
...
the data out of the old database**, and reconfigure the application away from hard-coded IPs
