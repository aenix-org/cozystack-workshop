...
--
-- The `orders` role and `orders` DB are created by the Postgres chart (Postgres CR), so
-- there is NO CREATE USER / CREATE DATABASE here — only the table and a bit of history.
--
