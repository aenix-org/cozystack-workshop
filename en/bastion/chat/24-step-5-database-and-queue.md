...
These two lines are exactly what, two steps from now, will replace the hardwired addresses `192.168.10.30`
...
Remember the difference itself: before, the application went to a hardwired address; now it goes by name.
