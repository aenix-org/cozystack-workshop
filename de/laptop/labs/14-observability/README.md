...
```bash
# port-forward = einen Tunnel vom Laptop in den Cluster graben. Während der Befehl läuft,
# landet eine Anfrage an localhost:8081 im Lastgenerator.
#   svc/fortio    das Ziel: der Service (nicht der Pod) namens fortio
#   8081:8080     links der Port auf Ihrem Laptop, rechts der Port innerhalb des Service
...
export COZY_KUBECONFIG=~/.kube/workshop     # die Zugangsdatei des Tenants
