...
| **Was Sie brauchen** | `helm` auf dem Laptop, `kubectl`, Tenant-Zugang. Der `lab`-Cluster wird hier nicht benötigt |
...
Der Fehler wird auf dem Laptop in einer halben Sekunde abgefangen. Ohne das Schema wäre er in den Cluster gewandert
...
📍 **Wo:** auf dem Laptop. Dafür wird kein Cluster benötigt.
...
📍 **Wo:** auf dem Laptop, mit Tenant-Zugang.
...
# client bedeutet, dass die gesamte Prüfung auf dem Laptop läuft und der Cluster nie etwas davon erfährt.
