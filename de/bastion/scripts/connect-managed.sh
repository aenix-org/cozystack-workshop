#!/bin/bash
# Die migrierte Anwendung von legacy hardcodierten IPs auf managed DNS-Endpoints umstellen.
...
# =========================================================================
# Die Standardwerte entsprechen manifests/04-managed.yaml (Postgres=db, Kafka=kafka).
# Ersetzen Sie nur tenant-workshopXX durch Ihren namespace. Wenn Sie Postgres/Kafka anders benannt haben —
# ändern Sie db/kafka in Ihre Namen.
