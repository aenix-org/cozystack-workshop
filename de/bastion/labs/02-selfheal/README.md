...
# Solange die Variable nicht gesetzt ist, sucht kubectl einen Cluster auf dem Bastion selbst und findet keinen.
...
Warum von innerhalb des Clusters und nicht vom Bastion: `port-forward` klammert sich an einen bestimmten Pod und
