...
```bash
# port-forward = cava un túnel desde la laptop hacia dentro del clúster. Mientras el comando corre,
...
#   8081:8080     a la izquierda, el puerto en tu laptop; a la derecha, el puerto dentro del service
...
export COZY_KUBECONFIG=~/.kube/workshop     # el archivo de acceso al tenant
