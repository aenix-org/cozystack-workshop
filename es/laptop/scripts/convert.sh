#!/bin/bash
# Conversión de VMware OVA -> qcow2 dentro de la conversion-VM.
...
#   El enlace al OVA de origen lo proporciona el operador (bucket común con las imágenes).
# =========================================================================
S3_ENDPOINT="https://s3.workshop.aenix.io"   # campo endpoint de Secrets, pero CON EL PREFIJO https://
                                             # (en el dashboard se muestra sin el esquema, añada https:// usted mismo)
...
OVA_URL="https://s3.workshop.aenix.io/bucket-a9209f83-4ac1-463e-8477-d8365bef787b/app-1.ova"  # demo-OVA listo del workshop (ya subido; puede reemplazarlo por el suyo)
# =========================================================================

echo "== 1. nested-virt? (si no hay /dev/kvm -> TCG, más lento, pero funciona) =="
...
echo "== 5. generando el enlace para el VM Disk (presigned, válido 7 días) =="
...
echo ""
echo "== LISTO. Copie la URL de la línea 'Share:' de arriba e insértela en"
echo "   manifests/03-app-vm.yaml (campo url), luego kubectl apply -f."
