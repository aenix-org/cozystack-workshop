...
| **Qué necesitas** | `helm` en el bastion, `kubectl`, acceso de tenant. El clúster `lab` no hace falta aquí |
...
El error se atrapa en el bastion en medio segundo. Sin el esquema habría llegado hasta el
...
📍 **Dónde:** en el bastion (en su terminal). Para esto no hace falta clúster.
...
📍 **Dónde:** en el bastion, con acceso de tenant.
...
# client significa que toda la comprobación corre en el bastion y el clúster ni siquiera se entera.
