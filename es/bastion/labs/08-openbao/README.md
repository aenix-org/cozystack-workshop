...
vive en la VM de un contratista que hizo una integración el año pasado.
...
(basado en token, no se abre ningún navegador). No hay nada que obtener ni guardar.
...
tendrás que instalarla en el bastion. Sustituye por tu propio número de tenant:
...
⚠️ **Copia ambos valores a un archivo en el bastion ahora mismo** — digamos en
...
con el bastion — pasado mañana es inútil. Una contraseña en un manifiesto no tiene esa propiedad.
