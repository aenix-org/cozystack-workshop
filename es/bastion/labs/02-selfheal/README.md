...
# Hasta que la variable no esté definida, kubectl busca un clúster en el propio bastion y no lo encuentra.
...
Por qué desde dentro del clúster y no desde el bastion: `port-forward` se engancha a un Pod concreto y
