...
`kind: Postgres` — de nuevo la postura del catálogo, igual que `Bucket` en la primera fase. No estás instalando un motor de base de datos: lo estás pidiendo. La propia plataforma levanta los procesos, configura la replicación, arma un calendario de respaldos y conecta la monitorización.
