...
Ahora abre `manifests/03-app-vm.yaml`, pega el enlace presigned en el campo `url`
y aplícalo:
...
• **VM Disk** `app-1` — 10Gi, source = http, esa misma URL presigned
...
en el campo URL — el enlace presigned, tamaño `10Gi`, storage class `replicated`.
