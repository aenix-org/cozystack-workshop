...
`namespace: tenant-workshopXX` — tu porción de la plataforma. En el archivo que está en el bastion, **tu
número ya está puesto aquí** — se rellenó al preparar el entorno de pruebas, así que no hay nada que cambiar (`XX`
se muestra solo como ejemplo). Un namespace es una partición dentro del clúster:
