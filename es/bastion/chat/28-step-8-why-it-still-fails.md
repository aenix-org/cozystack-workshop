...
📍 **Dónde:** dentro de tu propia máquina — la que levantaste en la tercera fase (app-VM). No en el bastion. Ya está en la red del clúster y ve la base de datos por su nombre.
...
<details>
<summary><b>Una mirada más de cerca: qué hay dentro de orders-schema.sql</b></summary>
