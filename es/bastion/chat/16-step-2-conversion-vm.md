...
**Por qué una máquina aparte, y no la propia VM.** La herramienta se llama `virt-v2v`, arrastra una montaña de dependencias y devora decenas de gigabytes. Instalarla en el bastion compartido desde el que todos trabajan es mala idea: es pequeño y hay uno solo para todos ustedes. Es más fácil levantar en el clúster una máquina desechable junto al almacenamiento, hacer el trabajo dentro y apagarla.

Como añadido, este es exactamente el enfoque que se usa para la conversión en proyectos reales de migración: la máquina conversora vive junto a los datos, no en la estación de trabajo de alguien a través de una VPN.
